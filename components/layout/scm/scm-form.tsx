          ...
          {step === 1 ? (
            <div>
              ...
              <button
                ...
                className="bg-[#12E193] text-white px-4 py-2 rounded cursor-pointer"
              >
            ...
            <div className=" max-w-3xl m-auto">
              ...
              <div className="flex flex-wrap sm:flex-col">
                <button
                  ...
                  className="bg-[#12E193] text-white px-4 py-2 rounded mr-4 mb-3 cursor-pointer"
                >
                  Procure-to-pay
                </button>
                <button
            ...
            <div>
              ...
              <Link href="/supply-health-check">
                <button
                  ...
                  className="bg-[#12E193] text-white px-4 py-2 rounded mt-4 cursor-pointer"
                >
                  Restart
                </button>
              </Link>
