...
const serviceOptions: Record<string, Option[]> = {
  ...
  "digital-marketing": [
    ...
    { label: "I'd like your guidance.", value: "req for digital-marketing advise" },
  ],
  "ppc-specialist": [
  ...
  "recruiter": [
    ...
    { label: "I'd like your guidance.", value: "req for recruiter advise" },
  ],
  "virtual-assistant": [
    ...
    { label: "I'd like your guidance.", value: "req for virtual-assistant advise" },
  ],
  "erp-specialist": [
    { label: "SAP", value: "SAP" },
    ...
    { label: "I'd like your guidance.", value: "req for erp advise" },
  ],
  "supply-chain": [
    ...
    { label: "Data and Integration Automation", value: "data and integration automation" },
    { label: "I'd like your guidance.", value: "req for supply-chain advise" },
  ],
  "bi-developer": [
    ...
    { label: "I'd like your guidance.", value: "req for bi-developer advise" },
  ],
};
