      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <Link
              href={helpCenterLink}
              className="flex items-center gap-2 px-4 py-2 bg-[#12E193] text-white rounded hover:bg-opacity-90"
            ...
            <Link
              ...
              className="px-4 py-2 border-2 border-[#12E193] text-[#12E193] rounded hover:bg-[#f0fdfc]"
        ...
        {/* Right Section: FAQs */}
        <div className="bg-[#12E193] text-white rounded-lg shadow p-6">
